...
export default function AddToCartForm() {
  ...
  return (
    <div className="product-form-actions flex items-start gap-4 mt-10">
      ...
      <button
        type="button"
        className="product-buy-now text-base leading-[19.6px] font-bold px-5 py-3 border border-neutral-950 rounded cursor-pointer hover:bg-neutral-950 hover:text-white"
        disabled={!available || isPending || !selectedVariant}
